...
- Planned Phase 20 to prevent repeated writer/validator loops: add a fallback GPT-based article writer identity, structured blocker-class retry rules, and deterministic recovery checks instead of frequent no-op LLM heartbeats.
