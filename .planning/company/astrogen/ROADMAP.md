...
- [ ] **Phase 47.1: Winning Structure Remote Contract Repair** - Remove false local validation success, make remote field-level validation authoritative, restore plugin/service startup integrity, and observe the resumed native article case through a real remote run.
