...
- [ ] **Phase 22: Telegram Attachment Delivery Groups** - Source implementation complete and verified locally. Production image cutover/smoke remains before the temporary direct Bot API delivery path can be retired.
