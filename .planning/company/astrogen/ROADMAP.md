...
- [ ] **Phase 20: Article Writer Fallback And Cost-Controlled Recovery** - Add a second writer model path for rescue rewrites after repeated validator failures, structured blocker-class retry rules, and deterministic recovery checks instead of frequent LLM heartbeats.
