        ...
        {companies.map((company) => {
          ...
          const budgetPct =
            company.budgetMonthlyUsd > 0
              ? Math.round(
                  (company.spentMonthlyUsd / company.budgetMonthlyUsd) * 100,
                )
              : 0;
            ...
            >
              ...
              <div className="flex items-center gap-3 sm:gap-5 mt-4 text-sm text-muted-foreground flex-wrap">
                ...
                <div className="flex items-center gap-1.5 tabular-nums">
                  ...
                  <span>
                    {formatUsd(company.spentMonthlyUsd)}
                    {company.budgetMonthlyUsd > 0
                      ? <> / {formatUsd(company.budgetMonthlyUsd)} <span className="text-xs">({budgetPct}%)</span></>
