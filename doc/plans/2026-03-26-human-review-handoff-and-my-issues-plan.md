...
- extended the discoverability model for human clarification without breaking agent ownership:
  - introduced a canonical company-level issue label: `Human Decision Needed`;
  - updated `My Issues` to include the union of:
    - active issues assigned to the current board user;
