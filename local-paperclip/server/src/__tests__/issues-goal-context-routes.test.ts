...
describe.sequential("issue goal context routes", () => {
  beforeEach(() => {
    ...
    mockIssueService.getChildHandoffSummary.mockResolvedValue(null);
  ...
  it("surfaces child handoff projection on GET /issues/:id/heartbeat-context", async () => {
    mockIssueService.getChildHandoffSummary.mockResolvedValue({
      childIssueIds: ["55555555-5555-4555-8555-555555555555"],
      childIssueSummaries: [
        {
          id: "55555555-5555-4555-8555-555555555555",
          identifier: "PAP-582",
    ...
    expect(res.status).toBe(200);
    expect(res.body.childWork).toEqual(expect.objectContaining({
      childIssueIds: ["55555555-5555-4555-8555-555555555555"],
      openChildCount: 1,
      terminalChildCount: 0,
      childIssueSummaryTruncated: false,
    }));
    expect(res.body.childWork.childIssueSummaries).toEqual([
      expect.objectContaining({
        identifier: "PAP-582",
        status: "in_progress",
        summary: "Layout stage is live.",
