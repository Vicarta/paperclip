...
import { sumBillableCostCentsSql } from "../services/cost-amounts.js";
...
function sumNumber(column: typeof costEvents.inputTokens | typeof costEvents.cachedInputTokens | typeof costEvents.outputTokens) {
