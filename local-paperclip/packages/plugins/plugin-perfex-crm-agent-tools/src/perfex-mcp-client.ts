...
function extractPerfexStatusText(value: unknown) {
...
function extractPaperclipResultStatus(text: string): PerfexFollowupDecision["paperclip_result_status"] {
...
function extractChangedUrls(text: string) {
