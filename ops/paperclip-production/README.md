...
- App image: `paperclip-app:v2026.529.0-vicarta.39-openrouter-image-cost`
...
- Plugin status at last smoke: `15` loaded, `15` succeeded, `0` failed.
- Current Git revision: `local-openrouter-image-cost`
